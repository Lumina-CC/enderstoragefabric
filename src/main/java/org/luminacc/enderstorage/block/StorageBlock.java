...
public class StorageBlock extends HorizontalFacingBlock implements BlockEntityProvider, InventoryProvider {
    ...
    public StorageBlock(Settings block$Settings_1) {
        ...
        Registry.register(Registries.BLOCK, Identifier.of(LinkedStorageMod.MOD_ID, "ender_chest"), this);
        blockEntity = Registry.register(Registries.BLOCK_ENTITY_TYPE, LinkedStorageMod.MOD_ID + ":ender_chest", FabricBlockEntityTypeBuilder.create(StorageBlockEntity::new, this).build(null));
	...
	ItemGroupEvents.modifyEntriesEvent(ItemGroups.FUNCTIONAL).register(entries -> entries.add(this));
        Registry.register(Registries.ITEM, Identifier.of(LinkedStorageMod.MOD_ID, "ender_chest"), item);
